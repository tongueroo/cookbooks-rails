...
set_unless[:mysql][:server_debian_password] = node[:mysql_root_password]
set_unless[:mysql][:server_root_password] = node[:mysql_root_password]
set_unless[:mysql][:server_repl_password] = node[:mysql_root_password]
